            ...
            <table className="table table-striped">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{new Date(this.state.leaveDetails.creationTime).toLocaleDateString('en-US', DATE_OPTIONS)}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    {new Date(this.state.leavePeriod.fromDate).toLocaleDateString('en-US', DATE_OPTIONS)} to{' '}
                    {new Date(this.state.leavePeriod.toDate).toLocaleDateString('en-US', DATE_OPTIONS)}
                  </td>
                </tr>
                <tr>
                  <td className="labels">Half or Full day:</td>
                  <td>{this.state.leaveDetails.isHalfDay ? 'Half day' : 'Full day'}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    {this.state.leaveDetails.actionDate
                      ? new Date(this.state.leaveDetails.actionDate).toLocaleDateString('en-US', DATE_OPTIONS)
                      : 'no data'}
                  </td>
                </tr>
                <tr>
